      ...
      <body>
        <main className="mx-auto grid min-h-screen w-full max-w-3xl place-items-center px-4 py-16">
          <section className="rounded-[var(--radius)] border border-border-grey bg-soft-grey p-8 sm:p-10" aria-labelledby="global-error-heading">
            ...
            <button type="button" onClick={reset} className="mt-7 inline-flex min-h-12 items-center justify-center rounded-[var(--radius)] border border-green bg-green px-5 py-3 font-bold text-white hover:border-navy hover:bg-navy">Try again</button>
          </section>
        </main>
      </body>
    </html>
