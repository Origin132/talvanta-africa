...
export default function HireTalentPage() {
  return <>
    <PageHero eyebrow="Hire Talent" title="Tell us about your hiring requirement" supportingText="Provide the information currently available about your vacancy or staffing need. Talvanta Africa will use the details to support structured recruitment review and follow-up." variation="dark" />
    ...
    <HiringRequestForm />
    <FutureProcess heading="How recruitment follow-up works" note="These steps explain how Talvanta Africa reviews hiring requirements and supports agreed next steps." steps={steps} disclaimer="Talvanta Africa does not guarantee candidate availability, successful placement, recruitment timelines, or employment outcomes. Employers remain responsible for their recruitment criteria, interviews, selection decisions, employment checks, and final hiring decisions." />
