...
export const applicationFormSchema = z.object({ coverNote: z.string().trim().max(5000, "Cover note must be 5,000 characters or fewer."), candidateDocumentId: z.union([z.literal(""), z.uuid()]) }).strict();
