...
type CandidateCompletionDetails = Pick<CandidateProfile, "phone" | "current_location" | "professional_title" | "professional_summary" | "preferred_roles">;

export function candidateCompletion(profile: Profile, details: CandidateCompletionDetails | null) {
